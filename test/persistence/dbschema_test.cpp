...
{
    return lhs.name == rhs.name && lhs.sql == rhs.sql;
}
...
private:
    ...
    void createSchemaAtVersion(std::shared_ptr<RawDatabase>,
                               const std::vector<SqliteMasterEntry>& schema);
...
void TestDbSchema::verifyDb(std::shared_ptr<RawDatabase> db,
                            const std::vector<SqliteMasterEntry>& expectedSql)
{
...
void TestDbSchema::createSchemaAtVersion(std::shared_ptr<RawDatabase> db,
                                         const std::vector<SqliteMasterEntry>& schema)
{

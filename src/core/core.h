...
signals:
    ...
    void groupPeerName(int groupnumber, int peernumber, const QString& name);
...
private:
    ...
    static void onGroupPeerName(Tox* tox, uint32_t groupId, uint32_t peerId,
                                const uint8_t* cName, size_t length, void* vCore);
    static void onGroupPeerListChanged(Tox* tox, uint32_t groupId, void* core);

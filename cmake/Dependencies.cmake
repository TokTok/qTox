...
find_package(ffmpeg)
if(TARGET ffmpeg::avcodec AND TARGET ffmpeg::avdevice AND TARGET ffmpeg::avformat AND TARGET ffmpeg::avutil AND TARGET ffmpeg::swscale)
  add_dependency(ffmpeg::avcodec)
  add_dependency(ffmpeg::avdevice)
  add_dependency(ffmpeg::avformat)
  add_dependency(ffmpeg::avutil)
  add_dependency(ffmpeg::swscale)
else()
...
if(TARGET libexif::libexif)
  add_dependency(libexif::libexif)
else()
  search_dependency(LIBEXIF             PACKAGE libexif)
endif()

find_package(libqrencode)
if(TARGET libqrencode::libqrencode)
  add_dependency(libqrencode::libqrencode)
else()
...
if(TARGET libsodium::libsodium)
  add_dependency(libsodium::libsodium)
else()
...
if(TARGET sqlcipher::sqlcipher)
  add_dependency(sqlcipher::sqlcipher)
else()
...
if(TARGET libvpx::libvpx)
  add_dependency(libvpx::libvpx)
else()
  search_dependency(LIBVPX              PACKAGE libvpx)
endif()
...
if(TARGET toxcore::toxcore)
  add_dependency(toxcore::toxcore)
  set(TOXCORE_FOUND TRUE)
elseif(WIN32)
